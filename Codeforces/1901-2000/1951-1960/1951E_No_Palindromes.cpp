...
void solve() {
    ...
    if (!palindrome) {
        ...
        bool still_after_palindrome = 1;
        for (int i = split + 2; i < N; i++) 
            if (str[i] != str[N + split + 1 - i]) {
                still_after_palindrome = 0;
            }
        ...
        if (split) {
            ...
            else if (split > 1 && split <= N / 2 - 1) {
                cout << "YES" << endl;
                cout << 2 << endl;
                for (int i = 0; i <= split + 1; i++) cout << str[i];
                cout << " ";
                for (int i = split + 2; i < N; i++) cout << str[i];
                cout << endl;
            }
            else cout << "NO" << endl;
        }
